...
class RejectionSampler(SpecDecodeStochasticBaseSampler):
    ...
    def forward_for_naive_eagle(
        ...
        draft_token_ids_fixed = torch.where(draft_token_ids == -1, torch.tensor(-2), draft_token_ids)
        posterior_mask = (target_token_ids == draft_token_ids_fixed).int()
        ...
        return output_token_ids, best_candidate_index, accept_length
